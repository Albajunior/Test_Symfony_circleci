 ...
 */
final class Version20230406114836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, userid_id INT NOT NULL, user_id INT NOT NULL, number INT NOT NULL, totalprice INT NOT NULL, INDEX IDX_F529939858E0A285 (userid_id), INDEX IDX_F5299398A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
